...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring(open('/uscms/home/aacharya/nobackup/CMSSW_13_0_13/src/SIM_TET.txt').readlines()),
    fileNames = cms.untracked.vstring('file:SIM_TET_merged_1to50.root'),
...
# Other statements
process.mixData.input.fileNames = cms.untracked.vstring([line.strip() for line in open('./pileup_fileslist.txt').readlines() if line.strip()])
...
#process.mixData.bunchspace = cms.int32(25)
