...
process.source = cms.Source("PoolSource",
    ...
    #fileNames = cms.untracked.vstring(open('/uscms/home/aacharya/nobackup/CMSSW_10_6_20/src/Gen1_list.txt').readlines()),
    #fileNames = cms.untracked.vstring('file:gen_100events.root'),
    fileNames = cms.untracked.vstring(open('/uscms/home/aacharya/nobackup/CMSSW_10_6_20/src/Gen_list_1M_unbiased_nodR_m170To175_pt400To600.txt').readlines()),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('file:sim_TToHadronic_1kevents.root')
    fileName = cms.untracked.string('file:sim_1Mevents.root')
)
